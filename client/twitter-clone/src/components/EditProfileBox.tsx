        ...
        <div className="flex flex-col h-full w-full items-center relative">
          ...
          <div className="w-full px-5 mt-24 h-14">
            <div className="relative w-full h-full">
              ...
              <label
                htmlFor="displayName"
                className="pointer-events-none absolute left-3 top-3 transform -translate-y-1/2 text-xs transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-lg peer-placeholder-shown:text-gray-500 peer-focus:top-3 peer-focus:text-xs peer-focus:text-sky-500"
              >
                Name
              </label>
            </div>
          </div>
          <div className="w-full px-5 mt-7 h-40">
            <div className="relative w-full h-full">
              <textarea
                id="displayName"
              ...
              <label
                htmlFor="displayName"
                className="pointer-events-none absolute left-3 top-3 transform -translate-y-1/2 text-xs transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-lg peer-placeholder-shown:text-gray-500 peer-focus:top-3 peer-focus:text-xs peer-focus:text-sky-500"
              >
                Bio
              </label>
            </div>
